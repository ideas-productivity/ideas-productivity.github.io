...
parent-event-file: parentconf-2018-11-11-sc18
#
...
# presenter-ids: [bernhold, adubey64, maheroux, jared321]
# helper-ids: 
presenters:
...
artifacts:
  - label: Tutorial webpage
    bsswt-event-label: 2018-11-12-sc
  - label: Slides
    format: FigShare
    doi: 10.6084/m9.figshare.c.4293800
    status: published
#
