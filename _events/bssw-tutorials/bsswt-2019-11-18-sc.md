...
parent-event-file: parentconf-2019-11-17-sc19
#
...
# presenter-ids: [bernhold, adubey64, mahreoux, jared321]
# helper-ids: [pagrubel, rinkug]
presenters:
...
artifacts:
  - label: Tutorial webpage
    bsswt-event-label: 2019-11-18-sc
  - label: Slides
    format: FigShare
    doi: 10.6084/m9.figshare.10114880
    status: published
#
