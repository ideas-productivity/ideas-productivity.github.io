...
The HPC-WDR Action Group originated as an extension of the [IDEAS-ECP](/activities/ideas-ecp) project as part of the [ECP Broadening Participation Initiative](https://www.exascaleproject.org/hpc-workforce/)'s strategy to expand the pipeline and workforce for DOE high-performance computing ([whitepaper](https://doi.org/10.6084/m9.figshare.17192492)).  The HPC-WDR Action Group organized a webinar series which discussed topics such as ally skills, diversifying computing, mentoring, and normalizing inclusion by embracing difference.
